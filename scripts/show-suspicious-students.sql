-- Show the 225 suspicious students before removing them
...
-- Students with very old creation dates
SELECT 
...
-- Students with default/test UUID patterns
SELECT 
...
-- Summary of all suspicious students
SELECT 
  'TOTAL SUSPICIOUS SUMMARY' as status,
