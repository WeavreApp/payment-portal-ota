-- Find test students created during app testing
...
-- Students with default/placeholder IDs
SELECT 
  ...
  id,
  CASE 
    WHEN id LIKE '00000000-%' THEN 'DEFAULT UUID PATTERN'
    WHEN id LIKE '12345678-%' THEN 'TEST UUID PATTERN'
    WHEN id LIKE 'ffffffff-%' THEN 'HEX UUID PATTERN'
