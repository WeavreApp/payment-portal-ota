-- Add bank accounts table for payment management
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_bank_accounts_student_level ON bank_accounts(student_level);
...
-- RLS: bank_accounts (super admin only)
